...
function kidazzle_slug_suggestion_metabox() {
	add_meta_box(
		...
		__( 'SEO Slug Suggestion', 'kidazzle' ),
...
function kidazzle_slug_suggestion_callback( $post ) {
	...
	<div class="KIDazzle-slug-info">
		<p><strong><?php _e( 'Suggested Slug:', 'kidazzle' ); ?></strong></p>
		<p><code><?php echo esc_html( $suggested_slug ?: 'N/A' ); ?></code></p>

		<p class="mt-2"><strong><?php _e( 'Suggested Full URL:', 'kidazzle' ); ?></strong></p>
		<p><code><?php echo esc_html( $full_url ); ?></code></p>

		<p class="mt-2"><strong><?php _e( 'Current Slug:', 'kidazzle' ); ?></strong></p>
		<p><code><?php echo esc_html( $current_slug ); ?></code></p>

		<p class="mt-3"><em><?php _e( 'Update the permalink manually to preserve existing URLs when needed.', 'kidazzle' ); ?></em></p>
	</div>
	<?php
}
