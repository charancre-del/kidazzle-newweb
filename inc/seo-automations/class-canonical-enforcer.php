...
class wimper_Canonical_Enforcer
{
    ...
    public function get_canonical_url()
    {
        ...
        $trailing_slash = get_option('wimper_seo_trailing_slash', true);
    ...
    {
        if (!get_option('wimper_seo_enable_canonical', true)) {
            return;
        }
    ...
    {
        if (!get_option('wimper_seo_redirect_canonical', false)) {
            return;
        }
