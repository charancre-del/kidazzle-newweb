...
class wimper_Related_Programs
{
    ...
    {
        if (!get_option('wimper_seo_link_programs_locations', true)) {
            return $content;
        }
    ...
    private function get_programs_at_location($location_id)
    {
        ...
        ob_start();
        ?>
        <section class="wimper-related-programs">
        ...
        <style>
            .wimper-related-programs {
                margin: 40px 0;
            }

            .wimper-related-programs h2 {
                margin-bottom: 20px;
            }
    ...
    private function get_locations_with_program($program_id)
    {
        ...
        ob_start();
        ?>
        <section class="wimper-locations-with-program">
        ...
        <style>
            .wimper-locations-with-program {
                margin: 40px 0;
            }

            .wimper-locations-with-program h2 {
                margin-bottom: 20px;
            }
