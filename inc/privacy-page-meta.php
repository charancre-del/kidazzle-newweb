...
function kidazzle_seed_privacy_page_defaults( $post_id ) {
	...
	$defaults = array(
		...
		'privacy_section1_content' => '<p class="mb-4">KIDazzle Child Care ("KIDazzle", "we", "us") respects your privacy. This policy outlines how we collect, use, and protect the personal information of our families, students, and website visitors.</p>',
...
<ul class="list-disc pl-6 mb-4 space-y-2">
  ...
  <li>Visit the center at any time during operating hours (Open Door Policy).</li>
		...
		'privacy_section5_content' => '<p class="mb-4">If you have questions regarding this policy, please contact our corporate office at privacy@kidazzle.com.</p>',
	);
