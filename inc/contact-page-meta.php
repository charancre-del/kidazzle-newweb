...
function kidazzle_contact_page_meta_boxes() {
	...
	add_meta_box(
		...
		__( 'Corporate Office Info', 'kidazzle' ),
	...
	add_meta_box(
		...
		__( 'Press Inquiries Section', 'kidazzle' ),
		...
		<tr>
			...
			<td>
				<input type="text" id="contact_corporate_name" name="contact_corporate_name"
					   ...
					   class="large-text" placeholder="e.g., KIDazzle Child Care HQ" />
			</td>
		</tr>
		<tr>
...
function kidazzle_seed_contact_page_defaults( $post_id ) {
	...
	$defaults = array(
		...
		'contact_corporate_name'    => 'KIDazzle Child Care HQ',
