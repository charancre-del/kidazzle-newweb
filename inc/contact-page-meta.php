 ...
 */
function wimper_contact_page_meta_boxes()
{
	add_meta_box(
		'wimper-contact-hero',
		__('Hero Section', 'wimper-theme'),
		'wimper_contact_hero_meta_box_render',
		'page',
		'normal',
		'high'
	);
	...
	add_meta_box(
		'wimper-contact-form',
		__('Form Settings', 'wimper-theme'),
		'wimper_contact_form_meta_box_render',
		'page',
		'normal',
		'default'
	);
	...
	add_meta_box(
		'wimper-contact-corporate',
		__('Corporate Office Info', 'wimper-theme'),
		'wimper_contact_corporate_meta_box_render',
		'page',
		'normal',
		'default'
	);
	...
	add_meta_box(
		'wimper-contact-careers',
		__('Careers Section', 'wimper-theme'),
		'wimper_contact_careers_meta_box_render',
		'page',
		'normal',
		'default'
	);
	...
	add_meta_box(
		'wimper-contact-press',
		__('Press Inquiries Section', 'wimper-theme'),
		'wimper_contact_press_meta_box_render',
		'page',
		'normal',
		'default'
	);
}
add_action('add_meta_boxes', 'wimper_contact_page_meta_boxes');

/**
 * Hero Section Meta Box
 */
function wimper_contact_hero_meta_box_render($post)
{
	wp_nonce_field('wimper_contact_hero_meta', 'wimper_contact_hero_nonce');
		...
		<tr>
			...
			<td>
				<input type="text" id="contact_hero_title" name="contact_hero_title"
					...
					placeholder="e.g., We'd love to meet you." />
			</td>
		</tr>
		<tr>
			<th><label for="contact_hero_description">Description</label></th>
			<td>
				<textarea id="contact_hero_description" name="contact_hero_description" rows="3"
 ...
 */
function wimper_contact_form_meta_box_render($post)
{
	wp_nonce_field('wimper_contact_form_meta', 'wimper_contact_form_nonce');
		...
		<tr>
			...
			<td>
				<input type="text" id="contact_form_submit_text" name="contact_form_submit_text"
					value="<?php echo esc_attr($form_submit_text); ?>" class="large-text"
					placeholder="e.g., Submit Request" />
			</td>
		</tr>
	</table>
	<p class="description">Form functionality can be configured with a contact form plugin (Contact Form 7, Gravity Forms,
		etc.)</p>
	<?php
}
 ...
 */
function wimper_contact_corporate_meta_box_render($post)
{
	wp_nonce_field('wimper_contact_corporate_meta', 'wimper_contact_corporate_nonce');
		...
		<tr>
			...
			<td>
				<input type="text" id="contact_corporate_title" name="contact_corporate_title"
					value="<?php echo esc_attr($corporate_title); ?>" class="large-text"
		...
		<tr>
			...
			<td>
				<input type="text" id="contact_corporate_name" name="contact_corporate_name"
					value="<?php echo esc_attr($corporate_name); ?>" class="large-text"
					placeholder="e.g., WIMPER Early Learning HQ" />
			</td>
		</tr>
		<tr>
			<th><label for="contact_corporate_address">Address</label></th>
			<td>
				<textarea id="contact_corporate_address" name="contact_corporate_address" rows="3" class="large-text"
		...
		<tr>
			...
			<td>
				<input type="text" id="contact_corporate_phone" name="contact_corporate_phone"
					value="<?php echo esc_attr($corporate_phone); ?>" placeholder="e.g., (404) 555-0199" />
			</td>
		</tr>
	</table>
	<?php
 ...
 */
function wimper_contact_careers_meta_box_render($post)
{
	wp_nonce_field('wimper_contact_careers_meta', 'wimper_contact_careers_nonce');
		...
		<tr>
			...
			<td>
				<input type="text" id="contact_careers_title" name="contact_careers_title"
					value="<?php echo esc_attr($careers_title); ?>" class="large-text" placeholder="e.g., Careers" />
			</td>
		</tr>
		<tr>
			<th><label for="contact_careers_description">Description</label></th>
			<td>
				<textarea id="contact_careers_description" name="contact_careers_description" rows="2"
					class="large-text"><?php echo esc_textarea($careers_description); ?></textarea>
			</td>
		</tr>
		<tr>
			...
			<td>
				<input type="text" id="contact_careers_link_text" name="contact_careers_link_text"
					value="<?php echo esc_attr($careers_link_text); ?>" class="large-text"
		...
		<tr>
			...
			<td>
				<input type="url" id="contact_careers_link_url" name="contact_careers_link_url"
					value="<?php echo esc_attr($careers_link_url); ?>" class="large-text" placeholder="e.g., /careers" />
			</td>
		</tr>
	</table>
	<?php
 ...
 */
function wimper_contact_press_meta_box_render($post)
{
	wp_nonce_field('wimper_contact_press_meta', 'wimper_contact_press_nonce');
	...
	<table class="form-table">
		<tr>
			...
			<td>
				<input type="text" id="contact_press_title" name="contact_press_title"
					value="<?php echo esc_attr($press_title); ?>" class="large-text"
		...
		<tr>
			...
			<td>
				<textarea id="contact_press_description" name="contact_press_description" rows="2"
					class="large-text"><?php echo esc_textarea($press_description); ?></textarea>
			</td>
		</tr>
		<tr>
			...
			<td>
				<input type="text" id="contact_press_link_text" name="contact_press_link_text"
					value="<?php echo esc_attr($press_link_text); ?>" class="large-text"
					placeholder="e.g., Visit Newsroom" />
			</td>
		</tr>
		<tr>
			...
			<td>
				<input type="url" id="contact_press_link_url" name="contact_press_link_url"
					value="<?php echo esc_attr($press_link_url); ?>" class="large-text" placeholder="e.g., /newsroom" />
			</td>
		</tr>
	</table>
	<?php
 ...
 */
function wimper_save_contact_page_meta($post_id)
{
	...
	$meta_boxes = array(
		'wimper_contact_hero_nonce' => array(
		...
		'wimper_contact_form_nonce' => array(
			'contact_form_submit_text' => 'sanitize_text_field',
		),
		'wimper_contact_corporate_nonce' => array(
		...
		'wimper_contact_careers_nonce' => array(
		...
		'wimper_contact_press_nonce' => array(
...
add_action('save_post', 'wimper_save_contact_page_meta');

/**
 * Seed default values for Contact page
 */
function wimper_seed_contact_page_defaults($post_id)
{
	if (get_post_type($post_id) !== 'page') {
		return;
	}
	...
	$defaults = array(
		...
		'contact_hero_description' => 'Ready to experience the WIMPER difference? Schedule a tour or ask us a question below to get started.',

		'contact_form_submit_text' => 'Submit Request',

		'contact_corporate_title' => 'Corporate Office',
		'contact_corporate_name' => 'WIMPER Early Learning HQ', // Updated from Kidazzle
...
add_action('save_post', 'wimper_seed_contact_page_defaults', 5);
