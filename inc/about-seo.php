...
function kidazzle_render_about_meta_box($post)
{
        ...
        <p>
                <label for="about_meta_title"
                        class="screen-reader-text"><?php esc_html_e('SEO Title', 'kidazzle'); ?></label>
                <input type="text" id="about_meta_title" name="about_meta_title" value="<?php echo esc_attr($meta_title); ?>"
                        class="widefat" />
                <small><?php esc_html_e('Custom title tag shown in search results and browser tabs.', 'kidazzle'); ?></small>
        </p>
        <p>
                ...
                <small><?php esc_html_e('1–2 sentence summary for search snippets.', 'kidazzle'); ?></small>
        </p>
        <p>
                <label for="about_structured_data"
                        class="screen-reader-text"><?php esc_html_e('Structured Data JSON-LD', 'kidazzle'); ?></label>
                ...
                <small><?php esc_html_e('Optional JSON-LD tailored to the About page.', 'kidazzle'); ?></small>
        </p>
        <?php
}
