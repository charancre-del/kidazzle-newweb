...
function kidazzle_stories_featured_meta_box_render( $post ) {
	...
	?>
	<p>
		<label for="stories_featured_post"><?php _e( 'Select Featured Post', 'kidazzle' ); ?></label>
		<select id="stories_featured_post" name="stories_featured_post" class="widefat">
			<option value=""><?php _e( 'None', 'kidazzle' ); ?></option>
		...
		<small><?php _e( 'This post will be displayed as the large featured post at the top of the Stories page.', 'kidazzle' ); ?></small>
	</p>
	<?php
}
