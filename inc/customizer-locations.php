...
function kidazzle_customize_locations($wp_customize)
{
    ...
    $wp_customize->add_section('kidazzle_locations_settings', array(
        'title' => __('Locations Archive', 'kidazzle'),
        'description' => __('Customize the title, subtitle, and labels for the Locations page.', 'kidazzle'),
        'priority' => 130,
    ));
    ...
    $wp_customize->add_control('kidazzle_locations_archive_title', array(
        'label' => __('Archive Page Title', 'kidazzle'),
        'description' => __('The main H1 title on the Locations page. HTML allowed.', 'kidazzle'),
    ...
    $wp_customize->add_control('kidazzle_locations_archive_subtitle', array(
        'label' => __('Archive Page Subtitle', 'kidazzle'),
        'description' => __('The subtitle text below the main title.', 'kidazzle'),
        'section' => 'kidazzle_locations_settings',
        'type' => 'textarea',
    ));
    ...
    $wp_customize->add_control('kidazzle_locations_label', array(
        'label' => __('"All Locations" Label', 'kidazzle'),
        'description' => __('The label used for buttons and filters (e.g., "All Areas", "View All Locations").', 'kidazzle'),
        'section' => 'kidazzle_locations_settings',
        'type' => 'text',
    ));
    ...
    $wp_customize->add_control('kidazzle_locations_badge_fallback', array(
        'label' => __('Badge Fallback Text', 'kidazzle'),
        'description' => __('Text to show on the location card badge if not "New Campus" (e.g., "Now Enrolling").', 'kidazzle'),
        'section' => 'kidazzle_locations_settings',
        'type' => 'text',
    ));
    ...
    $wp_customize->add_control('kidazzle_locations_open_text', array(
        'label' => __('"Open Now" Text', 'kidazzle'),
        'description' => __('Text displayed next to the pulsing dot when location is open.', 'kidazzle'),
        'section' => 'kidazzle_locations_settings',
        'type' => 'text',
    ));
