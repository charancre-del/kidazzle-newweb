...
function kidazzle_header_customizer_settings($wp_customize)
{
	...
	$wp_customize->add_section('kidazzle_header_settings', array(
		'title' => __('Header Settings', 'kidazzle'),
		'priority' => 30,
	));
	...
	$wp_customize->add_control('kidazzle_header_text', array(
		'label' => __('Header Text', 'kidazzle'),
		'description' => __('Enter text to display next to the logo. First line will be bold and larger. Additional lines will be small, uppercase, and blue.', 'kidazzle'),
	...
	$wp_customize->add_control('kidazzle_header_cta_text', array(
		'label' => __('Book a Tour Button Text', 'kidazzle'),
		'description' => __('Enter the text for the CTA button in the header.', 'kidazzle'),
		'section' => 'kidazzle_header_settings',
		'type' => 'text',
		'input_attrs' => array(
	...
	$wp_customize->add_control('kidazzle_book_tour_url', array(
		'label' => __('Book a Tour Button URL', 'kidazzle'),
		'description' => __('Enter the URL for the "Book a Tour" button in the header.', 'kidazzle'),
		'section' => 'kidazzle_header_settings',
		'type' => 'url',
		'input_attrs' => array(
	...
	$wp_customize->add_control('kidazzle_header_scripts', array(
		'label' => __('Header Scripts', 'kidazzle'),
		'description' => __('Scripts to be output before </head>.', 'kidazzle'),
		'section' => 'kidazzle_header_settings',
		'type' => 'textarea',
	));
	...
	$wp_customize->add_control('kidazzle_logo_width_desktop', array(
		'label' => __('Logo Width (Desktop)', 'kidazzle'),
		'description' => __('Width in pixels (default: 70).', 'kidazzle'),
		'section' => 'kidazzle_header_settings',
		'type' => 'range',
		'input_attrs' => array(
			'min' => 40,
	...
	$wp_customize->add_control('kidazzle_logo_width_mobile', array(
		'label' => __('Logo Width (Mobile)', 'kidazzle'),
		'description' => __('Width in pixels (default: 56).', 'kidazzle'),
		'section' => 'kidazzle_header_settings',
		'type' => 'range',
		'input_attrs' => array(
			'min' => 30,
