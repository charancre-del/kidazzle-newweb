...
function kidazzle_parents_page_meta_boxes()
{
    ...
    add_meta_box(
        ...
        __('Quick Links / Resources', 'kidazzle'),
    ...
    add_meta_box(
        ...
        __('Moments of Joy Gallery', 'kidazzle'),
...
function kidazzle_parents_gallery_meta_box_render($post)
{
    ...
    <table class="form-table">
        <tr>
            <th><label for="parents_moments_gallery"><?php _e('Image Gallery (URLs)', 'kidazzle'); ?></label>
            </th>
            <td>
                ...
                <p class="description">
                    <?php _e('Enter one image URL per line. These will be displayed in the carousel.', 'kidazzle'); ?>
                </p>
            </td>
        </tr>
    </table>
...
function kidazzle_seed_parents_page_defaults($post_id)
{
    ...
    $defaults = array(
        ...
        'parents_referral_button_url' => 'mailto:director@kidazzle.com?subject=Parent%20Referral',
    );
