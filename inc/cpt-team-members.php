...
{
    $labels = array(
        'name' => _x('Team Members', 'Post Type General Name', 'kidazzle'),
        'singular_name' => _x('Team Member', 'Post Type Singular Name', 'kidazzle'),
        'menu_name' => __('Team Members', 'kidazzle'),
        'all_items' => __('All Team Members', 'kidazzle'),
        'add_new_item' => __('Add New Team Member', 'kidazzle'),
        'edit_item' => __('Edit Team Member', 'kidazzle'),
        'view_item' => __('View Team Member', 'kidazzle'),
        'search_items' => __('Search Team Members', 'kidazzle'),
        'not_found' => __('No team members found', 'kidazzle'),
        'not_found_in_trash' => __('No team members found in Trash', 'kidazzle'),
    );

    $args = array(
        'label' => __('Team Member', 'kidazzle'),
        'labels' => $labels,
...
function kidazzle_team_member_add_meta_box()
{
    add_meta_box(
        ...
        __('Team Member Details', 'kidazzle'),
...
function kidazzle_team_member_render_meta_box($post)
{
    ...
    <p>
        <label for="team_member_title"
            style="font-weight:bold; display:block; margin-bottom:5px;"><?php _e('Job Title / Role', 'kidazzle'); ?></label>
        ...
        <span class="description"
            style="display:block; margin-top:5px;"><?php _e('e.g. "Executive Director" or "Lead Teacher"', 'kidazzle'); ?></span>
    </p>
    <?php
}
...
function kidazzle_team_member_admin_columns($columns)
{
    ...
    $new_columns['title'] = __('Name', 'kidazzle');
    $new_columns['role'] = __('Title', 'kidazzle');
...
function kidazzle_seed_default_team_members()
{
    ...
    $defaults = array(
        array(
            'post_title' => __('Jordan Avery', 'kidazzle'),
            'post_content' => __('Jordan leads the Prismpath team with a passion for creating joyful, evidence-based learning experiences for every child.', 'kidazzle'),
            'role' => __('Executive Director', 'kidazzle'),
        ),
        array(
            'post_title' => __('Samira Patel', 'kidazzle'),
            'post_content' => __('Samira partners with families and educators to ensure each center reflects the needs of its community.', 'kidazzle'),
            'role' => __('Director of Family Partnerships', 'kidazzle'),
        ),
        array(
            'post_title' => __('Luis Moreno', 'kidazzle'),
            'post_content' => __('Luis coaches classroom teams, championing playful curricula that meet students where they are.', 'kidazzle'),
            'role' => __('Director of Learning', 'kidazzle'),
        ),
    );
