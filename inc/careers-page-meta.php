...
function kidazzle_careers_page_meta_boxes() {
	...
	add_meta_box(
		...
		__( 'Culture & Benefits Section', 'kidazzle' ),
	...
	add_meta_box(
		...
		__( 'Current Opportunities Section (3 Job Listings)', 'kidazzle' ),
	...
	add_meta_box(
		...
		__( 'Application CTA Section', 'kidazzle' ),
...
function kidazzle_seed_careers_page_defaults( $post_id ) {
	...
	$defaults = array(
		...
		'careers_cta_button_url'  => 'mailto:careers@kidazzle.com',
	);
