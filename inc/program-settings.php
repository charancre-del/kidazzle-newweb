...
function kidazzle_program_settings_customize_register( WP_Customize_Manager $wp_customize ) {
	$wp_customize->add_section(
		...
		array(
			'title'       => __( 'Programs', 'kidazzle' ),
			'description' => __( 'Control the URL slug for the Program archive and permalinks.', 'kidazzle' ),
			'priority'    => 131,
		)
	);
	...
	$wp_customize->add_control(
		'kidazzle_program_base_slug',
		array(
			'label'       => __( 'Program base slug', 'kidazzle' ),
			'description' => __( 'Used for the Programs archive URL and individual program permalinks.', 'kidazzle' ),
