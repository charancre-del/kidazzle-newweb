...
{
	$labels = array(
		'name' => _x('Locations', 'Post Type General Name', 'kidazzle'),
		'singular_name' => _x('Location', 'Post Type Singular Name', 'kidazzle'),
		'menu_name' => __('Locations', 'kidazzle'),
		'all_items' => __('All Locations', 'kidazzle'),
		'add_new_item' => __('Add New Location', 'kidazzle'),
		'edit_item' => __('Edit Location', 'kidazzle'),
		'view_item' => __('View Location', 'kidazzle'),
	);

	$args = array(
		'label' => __('Location', 'kidazzle'),
		'labels' => $labels,
...
{
	$labels = array(
		'name' => _x('Location Regions', 'taxonomy general name', 'kidazzle'),
		'singular_name' => _x('Location Region', 'taxonomy singular name', 'kidazzle'),
		'search_items' => __('Search Location Regions', 'kidazzle'),
		'all_items' => __('All Location Regions', 'kidazzle'),
		'parent_item' => __('Parent Region', 'kidazzle'),
		'parent_item_colon' => __('Parent Region:', 'kidazzle'),
		'edit_item' => __('Edit Region', 'kidazzle'),
		'update_item' => __('Update Region', 'kidazzle'),
		'add_new_item' => __('Add New Region', 'kidazzle'),
		'new_item_name' => __('New Region Name', 'kidazzle'),
		'menu_name' => __('Location Regions', 'kidazzle'),
	);
	...
	register_taxonomy(
		...
		array(
			...
			'rewrite' => false,
			'default_term' => array(
				'name' => __('Uncategorized Locations', 'kidazzle'),
...
function kidazzle_location_admin_columns($columns)
{
	...
	$new_columns['city'] = __('City', 'kidazzle');
	$new_columns['state'] = __('State', 'kidazzle');
	$new_columns['phone'] = __('Phone', 'kidazzle');
	$new_columns['capacity'] = __('Capacity', 'kidazzle');
...
function kidazzle_location_title_placeholder($title)
{
	...
	if ('location' === $screen->post_type) {
		$title = __('e.g., Johns Creek Campus', 'kidazzle');
	}
	return $title;
}
...
function kidazzle_location_region_add_form_fields()
{
	...
	<div class="form-field">
		<label for="region_color_bg"><?php _e('Background Color Class', 'kidazzle'); ?></label>
		<input type="text" name="region_color_bg" id="region_color_bg" value="KIDazzle-greenLight"
			placeholder="e.g., KIDazzle-greenLight">
		<p class="description">
			<?php _e('Tailwind background color class (e.g., KIDazzle-greenLight, KIDazzle-redLight, KIDazzle-blueLight, KIDazzle-yellowLight, KIDazzle-purpleLight, KIDazzle-orangeLight, KIDazzle-tealLight)', 'kidazzle'); ?>
		</p>
	</div>
	<div class="form-field">
		<label for="region_color_text"><?php _e('Text Color Class', 'kidazzle'); ?></label>
		<input type="text" name="region_color_text" id="region_color_text" value="KIDazzle-green"
			placeholder="e.g., KIDazzle-green">
		<p class="description">
			<?php _e('Tailwind text color class (e.g., KIDazzle-green, KIDazzle-red, KIDazzle-blue, KIDazzle-yellow, KIDazzle-purple, KIDazzle-orange, KIDazzle-teal)', 'kidazzle'); ?>
		</p>
	</div>
	<div class="form-field">
		<label for="region_color_border"><?php _e('Border Color Class', 'kidazzle'); ?></label>
		<input type="text" name="region_color_border" id="region_color_border" value="KIDazzle-green"
			placeholder="e.g., KIDazzle-green">
		<p class="description">
			<?php _e('Tailwind border color class (e.g., KIDazzle-green, KIDazzle-red, KIDazzle-blue, KIDazzle-yellow, KIDazzle-purple, KIDazzle-orange, KIDazzle-teal)', 'kidazzle'); ?>
		</p>
	</div>
	<?php
}
...
function kidazzle_location_region_edit_form_fields($term)
{
	...
	?>
	<tr class="form-field">
		<th scope="row"><label for="region_color_bg"><?php _e('Background Color Class', 'kidazzle'); ?></label>
		</th>
		<td>
	...
	<tr class="form-field">
		<th scope="row"><label for="region_color_text"><?php _e('Text Color Class', 'kidazzle'); ?></label></th>
		<td>
	...
	<tr class="form-field">
		<th scope="row"><label for="region_color_border"><?php _e('Border Color Class', 'kidazzle'); ?></label>
		</th>
		<td>
...
function kidazzle_render_location_custom_fields_meta_box($post)
{
	...
	<div class="KIDazzle-meta-section">
		<h4><?php _e('Hero Section', 'kidazzle'); ?></h4>

		<div class="KIDazzle-meta-field">
			<label for="location_hero_subtitle"><?php _e('Hero Subtitle', 'kidazzle'); ?></label>
			...
			<small><?php _e('Small badge text shown above the location name', 'kidazzle'); ?></small>
		</div>

		<div class="KIDazzle-meta-field">
			<label for="location_hero_review_text"><?php _e('Hero Review Text', 'kidazzle'); ?></label>
			...
			<small><?php _e('Review text displayed in the floating badge (leave empty to hide)', 'kidazzle'); ?></small>
		</div>

		<div class="KIDazzle-meta-field">
			<label for="location_hero_review_author"><?php _e('Hero Review Author', 'kidazzle'); ?></label>
			...
			<small><?php _e('Author of the review (defaults to "Parent Review" if empty)', 'kidazzle'); ?></small>
		</div>

		<div class="KIDazzle-meta-field">
			<label for="location_hero_gallery"><?php _e('Hero Image Gallery (URLs)', 'kidazzle'); ?></label>
			...
			<small><?php _e('Enter image URLs (one per line). If provided, these will display as a carousel in the hero section. Leave empty to use the featured image.', 'kidazzle'); ?></small>
		</div>

		<div class="KIDazzle-meta-field">
			<label for="location_virtual_tour_embed"><?php _e('Virtual Tour Embed Code', 'kidazzle'); ?></label>
			...
			<small><?php _e('Paste the full embed code for your virtual tour. If provided, this will display on the location page. If empty, no space will be created on the page.', 'kidazzle'); ?></small>
		</div>

		<div class="KIDazzle-meta-field">
			<label for="location_tagline"><?php _e('Tagline', 'kidazzle'); ?></label>
			...
			<small><?php _e('Main tagline for this location (last 2 words will be italicized)', 'kidazzle'); ?></small>
		</div>

		<div class="KIDazzle-meta-field">
			<label for="location_description"><?php _e('Description', 'kidazzle'); ?></label>
			...
			<small><?php _e('Brief description shown in hero section', 'kidazzle'); ?></small>
		</div>
	</div>

	<div class="KIDazzle-meta-section">
		<h4><?php _e('Location Stats', 'kidazzle'); ?></h4>

		<div class="KIDazzle-meta-field">
			<label for="location_ages_served"><?php _e('Ages Served', 'kidazzle'); ?></label>
			...
			<small><?php _e('Age range served at this location', 'kidazzle'); ?></small>
		</div>

		<div class="KIDazzle-meta-field">
			<label for="location_special_programs"><?php _e('Special Programs (Badges)', 'kidazzle'); ?></label>
			...
			<small><?php _e('Enter programs separated by commas. These appear as badges on the location card.', 'kidazzle'); ?></small>
		</div>
	...
	<div class="KIDazzle-meta-field">
		<label for="location_quality_rated">
			...
			<?php _e('Quality Rated by Georgia DECAL', 'kidazzle'); ?>
		</label>
		<small><?php _e('Check if this location has achieved Georgia\'s Quality Rated status', 'kidazzle'); ?></small>
	</div>
		<div class="KIDazzle-meta-field">
			<label for="location_google_rating"><?php _e('Google Rating', 'kidazzle'); ?></label>
			...
			<small><?php _e('Google rating for this location (e.g., 4.9)', 'kidazzle'); ?></small>
		</div>

		<div class="KIDazzle-meta-field">
			<label for="location_hours"><?php _e('Hours', 'kidazzle'); ?></label>
			<input type="text" id="location_hours" name="location_hours" value="<?php echo esc_attr($hours); ?>"
				placeholder="e.g., 7am - 6pm" />
			<small><?php _e('Operating hours (Mon-Fri)', 'kidazzle'); ?></small>
		</div>
	</div>

	<div class="KIDazzle-meta-section">
		<h4><?php _e('Campus Director', 'kidazzle'); ?></h4>

		<div class="KIDazzle-meta-field">
			<label for="location_director_name"><?php _e('Director Name', 'kidazzle'); ?></label>
			...
			<small><?php _e('Name of the campus director (leave empty to hide director section)', 'kidazzle'); ?></small>
		</div>

		<div class="KIDazzle-meta-field">
			<label for="location_director_bio"><?php _e('Director Bio', 'kidazzle'); ?></label>
			...
			<small><?php _e('Brief bio/welcome message from the director', 'kidazzle'); ?></small>
		</div>

		<div class="KIDazzle-meta-field">
			<label for="location_director_photo"><?php _e('Director Photo', 'kidazzle'); ?></label>
			...
			<small><?php _e('Director photo (optional)', 'kidazzle'); ?></small>
		</div>

		<div class="KIDazzle-meta-field">
			<label for="location_director_signature"><?php _e('Director Signature Image', 'kidazzle'); ?></label>
			...
			<div class="KIDazzle-image-preview"></div>
			<small><?php _e('Director signature image (optional)', 'kidazzle'); ?></small>
		</div>
	</div>

	<div class="KIDazzle-meta-section">
		<h4><?php _e('Address & Contact', 'kidazzle'); ?></h4>

		<div class="KIDazzle-meta-field">
			<label for="location_address"><?php _e('Street Address', 'kidazzle'); ?></label>
		...
		<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px;">
			<div class="KIDazzle-meta-field">
				<label for="location_latitude"><?php _e('Latitude', 'kidazzle'); ?></label>
				<input type="text" id="location_latitude" name="location_latitude"
					value="<?php echo esc_attr($latitude); ?>" placeholder="33.9562" />
				<small><?php _e('For map integration (optional)', 'kidazzle'); ?></small>
			</div>

			<div class="KIDazzle-meta-field">
				<label for="location_longitude"><?php _e('Longitude', 'kidazzle'); ?></label>
	...
	<div class="KIDazzle-meta-section">
		<h4><?php _e('Google Maps & GMB', 'kidazzle'); ?></h4>

		<div class="KIDazzle-meta-field">
			<label for="location_gmb_url"><?php _e('Google My Business URL', 'kidazzle'); ?></label>
			...
			<small><?php _e('Direct URL to your Google My Business listing. Used by AI to enhance content generation.', 'kidazzle'); ?></small>
		</div>

		<div class="KIDazzle-meta-field">
			<label for="location_maps_embed"><?php _e('Google Maps Embed Code', 'kidazzle'); ?></label>
			...
			<small><?php _e('Paste the full iframe embed code from Google Maps. Go to Google Maps → Share → Embed a map', 'kidazzle'); ?></small>
		</div>
	</div>

	<div class="KIDazzle-meta-section">
		<h4><?php _e('Tour Booking', 'kidazzle'); ?></h4>

		<div class="KIDazzle-meta-field">
			<label for="location_tour_booking_link"><?php _e('Tour Booking Link', 'kidazzle'); ?></label>
			...
			<small><?php _e('External link for "Book a Tour Now" button (e.g., online scheduling system)', 'kidazzle'); ?></small>
		</div>
	</div>

	<div class="KIDazzle-meta-section">
		<h4><?php _e('School Pickups', 'kidazzle'); ?></h4>

		<div class="KIDazzle-meta-field">
			<label for="location_school_pickups"><?php _e('Elementary Schools', 'kidazzle'); ?></label>
			...
			<small><?php _e('Enter one school name per line. These will be displayed on the location page.', 'kidazzle'); ?></small>
		</div>
	</div>

	<div class="KIDazzle-meta-section">
		<h4><?php _e('Location SEO Content', 'kidazzle'); ?></h4>

		<div class="KIDazzle-meta-field">
			<label for="location_seo_content_title"><?php _e('SEO Content Title', 'kidazzle'); ?></label>
			...
			<small><?php _e('Title for the location-specific content section (e.g., "Early Education and Care in [City], GA")', 'kidazzle'); ?></small>
		</div>

		<div class="KIDazzle-meta-field">
			<label for="location_seo_content_text"><?php _e('SEO Content Description', 'kidazzle'); ?></label>
			...
			<small><?php _e('Location-specific description highlighting the area, accessibility, and unique features. This content appears at the bottom of the location page.', 'kidazzle'); ?></small>
		</div>
	</div>

	<div class="KIDazzle-meta-section">
		<h4><?php _e('Location-Specific FAQs (LLM SEO)', 'kidazzle'); ?></h4>

		<div class="KIDazzle-meta-field">
			<label for="location_faq_items"><?php _e('FAQ Items', 'kidazzle'); ?></label>
			...
			<small><?php _e('Enter FAQ items in format: Question|Answer (one per line). These appear in JSON endpoints for LLMs.', 'kidazzle'); ?></small>
		</div>
	</div>

	<div class="KIDazzle-meta-section">
		<p><strong><?php _e('Note:', 'kidazzle'); ?></strong>
			<?php _e('Use the "Featured Image" box in the sidebar to set the hero image for this location. Programs available at this location can be managed from the Programs admin section.', 'kidazzle'); ?>
		</p>
	</div>
	<?php
}
