...
function kidazzle_about_page_meta_boxes() {
	...
	add_meta_box(
		...
		__( 'Values (KIDazzle Standard) Section', 'kidazzle' ),
	...
	add_meta_box(
		...
		__( 'Leadership Section', 'kidazzle' ),
	...
	add_meta_box(
		...
		__( 'Nutrition & Wellness Section', 'kidazzle' ),
	...
	add_meta_box(
		...
		__( 'Philanthropy Section', 'kidazzle' ),
...
function kidazzle_seed_about_page_defaults( $post_id ) {
	...
	$defaults = array(
		...
		'about_story_paragraph1'           => 'KIDazzle Child Care began with a single location in Lawrenceville and a mission to redefine "daycare." We didn\'t just want to watch children; we wanted to ignite them.',
