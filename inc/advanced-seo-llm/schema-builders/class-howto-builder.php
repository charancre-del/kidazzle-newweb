...
class kidazzle_HowTo_Schema_Builder
{
    ...
    public static function build($post_id)
    {
        ...
        return [
            ...
            '@type' => 'HowTo',
            'name' => sprintf(__('How to Enroll at %s', 'kidazzle'), get_the_title($post_id)),
            'description' => sprintf(__('Step-by-step guide to enrolling your child at %s.', 'kidazzle'), get_the_title($post_id)),
            'step' => $step_objects,
        ];
    }
