...
class kidazzle_Schema_Injector
{
    ...
    public static function get_person_schema_data($post_id)
    {
        ...
        $schema = [
            ...
            'description' => $director_bio ? wp_strip_all_tags($director_bio) : sprintf(__('Director at %s', 'kidazzle'), get_the_title($post_id)),
        ];
        ...
        switch ($post_type) {
            case 'location':
                ...
                $defaults[] = [
                    ...
                    'data' => [
                        'name' => $location_name,
                        'description' => $description ?: sprintf(__('Quality childcare and early education at %s', 'kidazzle'), $location_name),
                        'address' => $address ?: '',
            ...
            case 'program':
                ...
                $defaults[] = [
                    ...
                    'data' => [
                        'name' => $program_name,
                        'description' => $program_desc ?: sprintf(__('%s program at KIDazzle Child Care', 'kidazzle'), $program_name),
                        'provider' => [
                            '@type' => 'Organization',
                            'name' => get_bloginfo('name'),
                            'url' => home_url()
