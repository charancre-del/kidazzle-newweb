...
class kidazzle_Hreflang_Options extends kidazzle_Advanced_SEO_Meta_Box_Base
{
    ...
    {
        return __('International SEO (Hreflang)', 'kidazzle');
    }
    ...
    public function render_fields($post)
    {
        ...
        <div class="KIDazzle-field-wrapper">
            <p class="description">
                <?php _e('Link this page to its translated counterpart. This tells Google that these are the same content in different languages.', 'kidazzle'); ?>
            </p>

            <div style="margin-bottom: 15px;">
                <label for="alternate_url_en"><?php _e('English Version URL:', 'kidazzle'); ?></label>
                ...
                <p class="description">
                    <?php _e('If this IS the English page, leave blank or enter self-ref.', 'kidazzle'); ?></p>
            </div>

            <div style="margin-bottom: 15px;">
                <label for="alternate_url_es"><?php _e('Spanish Version URL:', 'kidazzle'); ?></label>
                <input type="url" id="alternate_url_es" name="alternate_url_es" value="<?php echo esc_url($alternate_es); ?>"
                    class="widefat" placeholder="https://..." />
                <p class="description">
                    <?php _e('Enter the full URL of the Spanish version of this page.', 'kidazzle'); ?></p>
            </div>
        </div>
        <?php
    }
