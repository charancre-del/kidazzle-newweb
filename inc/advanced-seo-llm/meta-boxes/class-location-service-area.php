...
class kidazzle_Location_Service_Area_Meta_Box extends kidazzle_Advanced_SEO_Meta_Box_Base
{
    ...
    {
        return __('Service Area & Geo Targeting', 'kidazzle');
    }
    ...
    public function render_fields($post)
    {
        ...
        echo '<h4>' . __('Service Circle', 'kidazzle') . '</h4>';
        ...
        $this->render_number_field([
            ...
            'label' => __('Circle Center Latitude', 'kidazzle'),
            'value' => $lat,
            'step' => '0.000001',
        ...
        $this->render_number_field([
            ...
            'label' => __('Circle Center Longitude', 'kidazzle'),
            'value' => $lng,
            'step' => '0.000001',
        ...
        $this->render_number_field([
            ...
            'label' => __('Radius (miles)', 'kidazzle'),
            'value' => $radius,
            'step' => '0.5',
            'min' => '0',
            'placeholder' => '10',
        ...
        // Cities served
        echo '<h4 style="margin-top: 20px;">' . __('Cities Served', 'kidazzle') . '</h4>';
