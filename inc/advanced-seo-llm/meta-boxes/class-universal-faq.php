...
class kidazzle_Universal_FAQ extends kidazzle_Advanced_SEO_Meta_Box_Base
{
    ...
    {
        return __('FAQ Schema (LLM Optimized)', 'kidazzle');
    }
    ...
    public function render_fields($post)
    {
        ...
        <div class="KIDazzle-field-wrapper">
            <p class="description">
                <?php _e('Add Questions and Answers here. They will be output as <strong>FAQPage Schema</strong>, which is highly visible to Google and LLMs.', 'kidazzle'); ?>
            </p>
            ...
            <div class="KIDazzle-repeater-field">
                ...
                <button class="button KIDazzle-add-item"><?php _e('Add Question', 'kidazzle'); ?></button>
            </div>
        </div>
