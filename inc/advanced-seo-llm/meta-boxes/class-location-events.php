...
class kidazzle_Location_Events_Meta_Box extends kidazzle_Advanced_SEO_Meta_Box_Base
{
    ...
    {
        return __('Upcoming Events (Open Houses)', 'kidazzle');
    }
    ...
    public function render_fields($post)
    {
        ...
        <div class="KIDazzle-meta-section">
            <p class="description">
                <?php _e('Add upcoming open houses or parent nights. These will be marked up with Event schema.', 'kidazzle'); ?>
            </p>
            ...
            <div class="KIDazzle-repeater-field" data-field-id="location_events">
                ...
                <button type="button"
                    class="button KIDazzle-add-item-event"><?php _e('Add Event', 'kidazzle'); ?></button>
            </div>
        </div>
