...
class kidazzle_Program_Relationships extends kidazzle_Advanced_SEO_Meta_Box_Base
{
    ...
    {
        return __('Program Relationships & Availability', 'kidazzle');
    }
    ...
    public function render_fields($post)
    {
        ...
        <div class="KIDazzle-field-wrapper">
            <label><?php _e('Available at Locations', 'kidazzle'); ?></label>
            <p class="description">
                <?php _e('Select which locations offer this program. This builds the "areaServed" and "provider" schema relationships.', 'kidazzle'); ?>
            </p>
            ...
            <div
                ...
                <?php if ($locations): ?>
                    ...
                    <?php endforeach; ?>
                <?php else: ?>
                    <p><em><?php _e('No locations found.', 'kidazzle'); ?></em></p>
                <?php endif; ?>
            </div>
        </div>

        <div class="KIDazzle-field-wrapper">
            <label><?php _e('Prerequisites', 'kidazzle'); ?></label>
            <p class="description">
                <?php _e('Select programs that must be completed before this one (e.g., Preschool before Pre-K).', 'kidazzle'); ?>
            </p>
            ...
            <p class="description"><?php _e('Hold Ctrl/Cmd to select multiple.', 'kidazzle'); ?></p>
        </div>

        <div class="KIDazzle-field-wrapper">
            <label><?php _e('Related Programs', 'kidazzle'); ?></label>
            <p class="description">
                <?php _e('Select semantically related programs (e.g., Summer Camp related to After School).', 'kidazzle'); ?>
            </p>
