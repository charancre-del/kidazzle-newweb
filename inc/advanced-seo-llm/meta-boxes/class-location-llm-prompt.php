...
class kidazzle_Location_LLM_Prompt_Meta_Box extends kidazzle_Advanced_SEO_Meta_Box_Base
{
    public function get_id()
    {
        return 'kidazzle_location_llm_prompt';
    }

    public function get_title()
    {
        return __('LLM Description & Recommendations', 'kidazzle');
    }
    ...
    public function render_fields($post)
    {
        ...
        // LLM Description
        echo '<h4>' . __('Natural Language Description', 'kidazzle') . '</h4>';

        $this->render_textarea_field([
            'id' => 'seo_llm_description',
            'label' => __('LLM-Optimized Description', 'kidazzle'),
        ...
        // When to recommend
        echo '<h4 style="margin-top: 20px;">' . __('"When to Recommend" Criteria', 'kidazzle') . '</h4>';
