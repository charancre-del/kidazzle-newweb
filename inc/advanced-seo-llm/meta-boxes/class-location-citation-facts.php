...
class kidazzle_Location_Citation_Facts_Meta_Box extends kidazzle_Advanced_SEO_Meta_Box_Base
{
    ...
    {
        return __('Citation Facts (LLM)', 'kidazzle');
    }
    ...
    private function render_fact_item($index, $fact)
    {
        ...
        <div class="citation-fact-item"
            ...
            <div style="margin-bottom: 10px;">
                <label><?php _e('Fact Label', 'kidazzle'); ?></label>
            ...
            <div style="margin-bottom: 10px;">
                <label><?php _e('Value', 'kidazzle'); ?></label>
            ...
            <div style="margin-bottom: 10px;">
                <label><?php _e('Source (optional)', 'kidazzle'); ?></label>
            ...
            <div style="margin-bottom: 10px;">
                <label><?php _e('Context (optional)', 'kidazzle'); ?></label>
            ...
            <button type="button" class="button citation-fact-remove"><?php _e('Remove Fact', 'kidazzle'); ?></button>
        </div>
        <?php
    }
