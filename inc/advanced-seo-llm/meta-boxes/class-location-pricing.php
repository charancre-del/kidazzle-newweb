...
class kidazzle_Location_Pricing_Meta_Box extends kidazzle_Advanced_SEO_Meta_Box_Base
{
    ...
    {
        return __('Tuition & Offers', 'kidazzle');
    }
