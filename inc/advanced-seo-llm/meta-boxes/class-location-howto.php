...
class kidazzle_Location_HowTo_Meta_Box extends kidazzle_Advanced_SEO_Meta_Box_Base
{
    ...
    {
        return __('How to Enroll (HowTo Schema)', 'kidazzle');
    }
    ...
    public function render_fields($post)
    {
        ...
        <div class="KIDazzle-meta-section">
            <p class="description">
                <?php _e('Define the enrollment process steps. Google uses this to generate "HowTo" rich snippets.', 'kidazzle'); ?>
            </p>
            ...
            <div class="KIDazzle-repeater-field" data-field-id="location_enrollment_steps">
                ...
                <button type="button"
                    class="button KIDazzle-add-item-howto"><?php _e('Add Step', 'kidazzle'); ?></button>
            </div>
        </div>
