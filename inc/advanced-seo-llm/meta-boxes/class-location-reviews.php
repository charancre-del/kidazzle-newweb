...
class kidazzle_Location_Reviews_Meta_Box extends kidazzle_Advanced_SEO_Meta_Box_Base
{
    ...
    {
        return __('Reviews & Rating', 'kidazzle');
    }
    ...
    public function render_fields($post)
    {
        ...
        // Aggregate Rating
        echo '<h4>' . __('Aggregate Rating', 'kidazzle') . '</h4>';

        $this->render_number_field([
            'id' => 'seo_llm_aggregate_rating_value',
            'label' => __('Rating Value (0-5)', 'kidazzle'),
            'value' => $rating_value,
            'step' => '0.1',
            'min' => '0',
            'max' => '5',
        ...
        $this->render_number_field([
            ...
            'label' => __('Review Count', 'kidazzle'),
            'value' => $rating_count,
            'step' => '1',
            'min' => '0',
            'placeholder' => '127',
        ...
        $this->render_number_field([
            ...
            'label' => __('Worst Rating', 'kidazzle'),
            'value' => $rating_worst,
            'step' => '1',
            'min' => '1',
            'placeholder' => '1',
