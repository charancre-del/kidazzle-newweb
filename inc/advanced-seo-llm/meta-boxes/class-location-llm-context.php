...
class kidazzle_Location_LLM_Context_Meta_Box extends kidazzle_Advanced_SEO_Meta_Box_Base
{
    public function get_id()
    {
        return 'kidazzle_location_llm_context';
    }

    public function get_title()
    {
        return __('LLM Context & Targeting', 'kidazzle');
    }
    ...
    public function render_fields($post)
    {
        ...
        $this->render_text_field([
            ...
            'label' => __('Primary Intent', 'kidazzle'),
        ...
        // Target queries
        echo '<h4 style="margin-top: 20px;">' . __('Target Queries', 'kidazzle') . '</h4>';
        ...
        // Key differentiators
        echo '<h4 style="margin-top: 20px;">' . __('Key Differentiators', 'kidazzle') . '</h4>';
