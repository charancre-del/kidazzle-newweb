...
class kidazzle_Citation_Datasets
{
    ...
    public function render_page()
    {
        ...
        ?>
        <div class="wrap">
            <h1><?php _e('Citation Datasets & Global Facts', 'kidazzle'); ?></h1>
            <p class="description">
                <?php _e('Manage global facts about your organization. These are exposed via JSON for AI bots (ChatGPT, Perplexity) to cite as truth.', 'kidazzle'); ?>
            </p>

            <div class="card" style="max-width: 100%; margin-top: 20px; padding: 20px;">
                <h3><?php _e('AI Data Endpoint', 'kidazzle'); ?></h3>
                <p>
                    <?php _e('Your structured data is available at:', 'kidazzle'); ?>
                    <br>
            ...
            <form method="post" action="options.php">
                ...
                <p><button type="button" class="button"
                        id="KIDazzle-add-fact"><?php _e('+ Add Fact', 'kidazzle'); ?></button></p>
