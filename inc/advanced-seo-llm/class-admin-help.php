...
class kidazzle_Admin_Help
{
    ...
    {
        echo '<a href="?page=KIDazzle-seo-dashboard&tab=help" class="nav-tab ' . ($this->is_active() ? 'nav-tab-active' : '') . '">' . __('Help & Guides', 'kidazzle') . '</a>';
    }
    ...
    public function render_content()
    {
        ...
        <div class="KIDazzle-seo-card">
            <h2><?php _e('Advanced SEO & LLM Guide', 'kidazzle'); ?></h2>
