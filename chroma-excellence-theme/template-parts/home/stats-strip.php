...
<section class="bg-white py-12 border-y border-chroma-blue/10" data-section="stats">
        <div class="max-w-6xl mx-auto px-4 lg:px-6 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                <?php foreach ( $stats as $stat ) : ?>
                        ...
                        ?>
                        <div class="group">
                                <div class="font-serif text-3xl font-bold <?php echo esc_attr( $color_class ); ?> group-hover:scale-110 transition-transform duration-300"><?php echo esc_html( $stat['value'] ); ?></div>
