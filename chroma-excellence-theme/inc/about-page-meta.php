...
function chroma_about_page_meta_boxes()
{
	...
	add_meta_box(
		'chroma-about-values',
		__('Values (Kidazzle Standard) Section', 'chroma-excellence'),
	...
	<table class="form-table">
		...
		<tr>
			...
			<td>
				...
				<p class="description">Use &lt;span class='text-chroma-yellow italic'&gt;text&lt;/span&gt; for yellow italic
					text</p>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				<input type="text" id="about_hero_image" name="about_hero_image"
					value="<?php echo esc_attr($hero_image); ?>" class="large-text chroma-image-field" />
				<button type="button" class="button chroma-upload-button" data-field="about_hero_image">Select
					Image</button>
		...
		<tr>
			...
			<td>
				<input type="text" id="about_story_image" name="about_story_image"
					value="<?php echo esc_attr($story_image); ?>" class="large-text chroma-image-field" />
				<button type="button" class="button chroma-upload-button" data-field="about_story_image">Select
					Image</button>
		...
		<tr>
			...
			<td>
				<input type="text" id="about_educators_title" name="about_educators_title"
					...
					placeholder="e.g., The Heart of Chroma." />
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				<input type="text" id="about_values_title" name="about_values_title"
					...
					placeholder="e.g., The Kidazzle Standard" />
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				<input type="text" id="about_nutrition_image" name="about_nutrition_image"
					value="<?php echo esc_attr($nutrition_image); ?>" class="large-text chroma-image-field" />
				<button type="button" class="button chroma-upload-button" data-field="about_nutrition_image">Select
					Image</button>
		...
		<tr>
			...
			<td>
				<input type="text" id="about_philanthropy_image" name="about_philanthropy_image"
					value="<?php echo esc_attr($philanthropy_image); ?>" class="large-text chroma-image-field" />
				<button type="button" class="button chroma-upload-button" data-field="about_philanthropy_image">Select
					Image</button>
