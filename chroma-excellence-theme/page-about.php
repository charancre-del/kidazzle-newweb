...
while (have_posts()):
	...
	$educator3_desc = get_post_meta($page_id, 'about_educator3_desc', true) ?: 'Our educators participate in 20+ hours of annual professional development, specializing in the Kidazzle™ curriculum and social-emotional learning.';
	...
	$value3_desc = get_post_meta($page_id, 'about_value3_desc', true) ?: 'Using our Kidazzle™ model, we deliver rigorous, age-appropriate learning that feels like play.';
