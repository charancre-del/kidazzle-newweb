...
<head>
    ...
    <title>Best Daycare & Preschool in <?php echo esc_html($city); ?>, GA | KIDazzle Child Care</title>
    ...
    <script type="application/ld+json">
  {
    ...
    "name": "KIDazzle Child Care - <?php echo esc_js($city); ?> Region",
...
<body class="bg-brand-cream text-brand-ink antialiased">
    ...
    <header class="sticky top-0 z-50 bg-white/90 backdrop-blur-xl border-b border-KIDazzle-blue/10">
        <div class="max-w-7xl mx-auto px-4 h-[82px] flex items-center justify-between">
            <a href="/"
                class="font-bold text-lg text-brand-ink focus:outline-none focus:ring-2 focus:ring-KIDazzle-blue rounded-lg px-2">KIDazzle
                <span class="text-KIDazzle-blue text-xs uppercase tracking-widest ml-2"><?php echo esc_html($city); ?>
                    Area</span></a>
            <a href="#locations"
    ...
    <main>
        ...
        <section class="py-20 bg-brand-cream border-t border-brand-ink/5">
            <div class="max-w-4xl mx-auto px-4">
                ...
                <div class="space-y-4">
                    <details
                        class="group bg-white rounded-2xl p-6 shadow-sm border border-brand-ink/5 cursor-pointer focus-within:ring-2 focus-within:ring-KIDazzle-blue focus-within:ring-offset-2">
                        <summary
    ...
    <footer class="bg-brand-ink text-white py-12 text-center text-sm opacity-60">
        <p>© <?php echo date('Y'); ?> KIDazzle Child Care. Proudly serving <?php echo esc_html($city); ?> and
